     ...
     <div className='flex flex-col'>
        {filteredUsers.map((user, index)=>(
            ...
            cursor-pointer max-sm:text-sm ${selectedUser?._id === user._id && 'bg-[#282142]/50'}`}>
                ...
                {unseenMessages[user._id] > 0 && <p className='absolute top-4 right-4 text-xs h-5 w-5 flex justify-center items-center items-center rounded-full bg-violet-500/50'>
